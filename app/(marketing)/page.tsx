...
// (marketing)/layout.tsx and the styles in app/autoreviver.css.
//
// Pulls a featured listing + the vehicle list out of Supabase so the demo card
// on the right is backed by the real compat + trust algorithms.
